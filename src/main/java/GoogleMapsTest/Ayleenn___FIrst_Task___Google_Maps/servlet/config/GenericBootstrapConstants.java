package GoogleMapsTest.Ayleenn___FIrst_Task___Google_Maps.servlet.config;
...
public class GenericBootstrapConstants {
	 ...
	 */
	public static final String JERSEY_PROPERTY_PACKAGES="GoogleMapsTest.Ayleenn___FIrst_Task___Google_Maps.rest";
